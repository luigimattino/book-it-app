...
<html lang="en">
    ...
    <body>
        <div class="container py-5">
            <div class="row">
                <div class="col-md-12">
                    <h2 class="text-center mb-5">Space Slot</h2>
                </div>
            </div>
            <div class="card card-outline-secondary">
                <div class="card-body">
                    <form:form action="/space-slot/${slot.id}/update" modelAttribute="slot" method="post">
                        ...
                        <input type="submit" value="Update Space Slot">
                    </form:form>
                </div>
            </div>
        </div>
